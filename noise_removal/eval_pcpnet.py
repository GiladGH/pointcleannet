...
def parse_arguments():
    ...
    parser.add_argument('--sampling', type=str, default='full', help='sampling strategy, any of:\n'
                        ...
                        'sequential_shapes_random_patches: pick n rando points from each shape as patch centers, shape order is not randomized')
    parser.add_argument('--patches_per_shape', type=int, default=50, help='number of patches evaluated in each shape (only for sequential_shapes_random_patches)')
    ...
    parser.add_argument('--shapename', type=str, default='column_head100k_noise_white_1.50e-02_{i}', help='shape to evaluate format : name{i}')
